                ...
                <div className="flex justify-center md:justify-start mx-4 py-10 md:py-14">
                    <div className="md:px-5">
                        <div className="text-center mt-10 text-white">
                            <p className="font-pop md:leading-snug text-center md:text-left font-bold text-2xl sm:text-3xl md:text-4xl mb-3 lg:w-2/3 xl:w-2/4">Financiamiento para nuestros productos y servicios</p>
                        </div>
