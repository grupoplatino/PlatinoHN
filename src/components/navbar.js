        ...
        <nav className={`${show && typeNav} fixed left-0 right-0 z-10`}>
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="flex-1 flex items-center ml-4 sm:items-stretch lg:justify-between">
                    ...
                    <div className="hidden lg:flex lg:right-0 lg:inset-y-0 lg:items-center lg:pl-4">
